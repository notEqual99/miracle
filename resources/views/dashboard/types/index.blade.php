                ...
                <div class="col-md-12">
                    <div class="card card-default">
                        ...
                        <div class="d-flex justify-content-left m-2">
                            ...
                            <a href="{{route('types.create')}}" class="btn btn-warning ml-2">
                                Archived
                            </a>
                        </div>
                                        ...
                                        @foreach($types as $type)
                                            <tr>
                                               ...
                                               <td class="text-center">
                                                    <a href="{{route('types.edit',$type->id)}}" class="btn btn-info btn-sm d-inline">Edit</a>
                                                    <form action="{{route('types.destroy',$type->id)}}" class="d-inline" method="post">
                                                        {{csrf_field()}}
                                                        {{method_field('Delete')}}
